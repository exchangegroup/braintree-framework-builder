...
This guide shows how to build a Braintree framework from Braintree iOS SDK sources. Once built, you will be able to just drag `Braintree.framework` to any of your apps, Objective-C or Swift.
